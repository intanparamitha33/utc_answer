...
@section('content')
<div class="m-auto">
    <div id="book-details" class="flex flex-row my-[2vw] mx-[3vw]">
        <div class="w-full">
            <h1 class="text-[2.5vw] font-bold">{{ $details->Book->title }}</h1>
            <p>{{ $details->Book->description }}</p>
            <div class="flex">
                <p class="mr-[0.3vw]">{{ $details->author }} | </p>
                <p class="ml-[0.3vw] mr-[1vw]">{{ $details->date }}</p>
                @if ($details->readingTime == 1)
                    <p class="bg-green-300 px-[0.2vw]">Quicks Reads</p>
                @elseif ($details->readingTime == 2)
                    <p class="bg-yellow-300 px-[0.2vw]">Medium Reads</p>
                @elseif ($details->readingTime == 3)
                    <p class="bg-red-300 px-[0.2vw]">Long Reads</p>
                @endif
            </div>
            <img src="{{ $details->Book->image }}" class="w-full h-[25vw] m-auto mt-[2vw]" alt="">
            <div class="flex my-[0.5vw] gap-2">
